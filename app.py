...
def analyze(): 
    ...
    #rock segments
    segment_count = int(request.form.get('segment_count'))
    sections = []
    ...
    if data_method == 'CSV':
        ...
        # delete all old files before saving new one
...
if __name__ == "__main__":
    ...
    csv_file_path = r'C:\Users\ArthurTian-Geososurc\repos\tc-test-analyzer\Pat_Apts-2025_11_28_10_45_07_EST (1) (1).csv'
    process('CSV', csv_file_path, sections, 850, 1.5, 60, 0, 0)
